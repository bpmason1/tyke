...
entry.while.635db1d4369930b51ec7188e2e5c5a23:
  %".7" = load i64, i64* %"x"
  %".8" = icmp eq i64 %".7", 1
  br i1 %".8", label %"entry.while.635db1d4369930b51ec7188e2e5c5a23.if", label %"entry.while.635db1d4369930b51ec7188e2e5c5a23.endif"
exit.while.635db1d4369930b51ec7188e2e5c5a23:
  ret i64 0
entry.while.635db1d4369930b51ec7188e2e5c5a23.if:
  br label %"exit.while.635db1d4369930b51ec7188e2e5c5a23"
entry.while.635db1d4369930b51ec7188e2e5c5a23.endif:
  %".11" = load i64, i64* %"x"
  %"d" = getelementptr inbounds [4 x i8], [4 x i8]* @"print_call_0", i32 0, i32 0
  %".12" = call i32 (i8*, ...) @"printf"(i8* %"d", i64 %".11")
  %".13" = load i64, i64* %"x"
  %".14" = sub i64 %".13", 1
  store i64 %".14", i64* %"x"
  br label %"predicate.while.635db1d4369930b51ec7188e2e5c5a23"
