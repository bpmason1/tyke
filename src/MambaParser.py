...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\t\31\4\32\t\32\4\33\t\33\3\2\3\2\6\29\n\2\r\2\16\2:\3")
        buf.write("\3\3\3\3\3\3\3\3\4\3\4\3\4\5\4D\n\4\3\4\3\4\3\5\3\5\3")
        buf.write("\5\3\5\3\5\3\5\3\6\6\6O\n\6\r\6\16\6P\3\7\3\7\3\7\5\7")
        buf.write("V\n\7\3\b\3\b\3\b\3\b\3\b\3\b\5\b^\n\b\3\b\3\b\3\t\3\t")
        buf.write("\3\t\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\5\nn\n\n\3\n")
        buf.write("\3\n\3\13\3\13\5\13t\n\13\3\13\3\13\3\f\3\f\3\f\7\f{\n")
        buf.write("\f\f\f\16\f~\13\f\3\r\3\r\3\r\3\r\3\16\3\16\3\17\3\17")
        ...
        buf.write("\21\3\21\6\21\u00b3\n\21\r\21\16\21\u00b4\3\21\3\21\5")
        buf.write("\21\u00b9\n\21\3\22\3\22\3\23\3\23\3\24\3\24\3\25\3\25")
        buf.write("\3\25\5\25\u00c4\n\25\3\26\3\26\3\26\3\27\3\27\5\27\u00cb")
        ...
        buf.write("\u008c\3\2\2\2\u008c\u009b\3\2\2\2\u008d\u008b\3\2\2\2")
        buf.write("\u008e\u008f\7\t\2\2\u008f\u0095\5(\25\2\u0090\u0091\5")
        buf.write("\32\16\2\u0091\u0092\5(\25\2\u0092\u0094\3\2\2\2\u0093")
        buf.write("\u0090\3\2\2\2\u0094\u0097\3\2\2\2\u0095\u0093\3\2\2\2")
        buf.write("\u0095\u0096\3\2\2\2\u0096\u0098\3\2\2\2\u0097\u0095\3")
        buf.write("\2\2\2\u0098\u0099\7\n\2\2\u0099\u009b\3\2\2\2\u009a\u0085")
        buf.write("\3\2\2\2\u009a\u008e\3\2\2\2\u009b\35\3\2\2\2\u009c\u00a2")
        buf.write("\5\34\17\2\u009d\u009e\5\32\16\2\u009e\u009f\5\34\17\2")
        buf.write("\u009f\u00a1\3\2\2\2\u00a0\u009d\3\2\2\2\u00a1\u00a4\3")
        buf.write("\2\2\2\u00a2\u00a0\3\2\2\2\u00a2\u00a3\3\2\2\2\u00a3\37")
        buf.write("\3\2\2\2\u00a4\u00a2\3\2\2\2\u00a5\u00a9\5(\25\2\u00a6")
        buf.write("\u00a7\5\"\22\2\u00a7\u00a8\5(\25\2\u00a8\u00aa\3\2\2")
        ...
        buf.write("\u00b7\u00b9\3\2\2\2\u00b8\u00a5\3\2\2\2\u00b8\u00ad\3")
        buf.write("\2\2\2\u00b9!\3\2\2\2\u00ba\u00bb\t\3\2\2\u00bb#\3\2\2")
        buf.write("\2\u00bc\u00bd\t\4\2\2\u00bd%\3\2\2\2\u00be\u00bf\t\5")
        buf.write("\2\2\u00bf\'\3\2\2\2\u00c0\u00c4\5&\24\2\u00c1\u00c4\7")
        buf.write("\"\2\2\u00c2\u00c4\5*\26\2\u00c3\u00c0\3\2\2\2\u00c3\u00c1")
        buf.write("\3\2\2\2\u00c3\u00c2\3\2\2\2\u00c4)\3\2\2\2\u00c5\u00c6")
        buf.write("\7\"\2\2\u00c6\u00c7\5,\27\2\u00c7+\3\2\2\2\u00c8\u00ca")
        buf.write("\7\t\2\2\u00c9\u00cb\5.\30\2\u00ca\u00c9\3\2\2\2\u00ca")
        buf.write("\u00cb\3\2\2\2\u00cb\u00cc\3\2\2\2\u00cc\u00cd\7\n\2\2")
        buf.write("\u00cd-\3\2\2\2\u00ce\u00d3\5\60\31\2\u00cf\u00d0\7\13")
        buf.write("\2\2\u00d0\u00d2\5\60\31\2\u00d1\u00cf\3\2\2\2\u00d2\u00d5")
        buf.write("\3\2\2\2\u00d3\u00d1\3\2\2\2\u00d3\u00d4\3\2\2\2\u00d4")
        buf.write("/\3\2\2\2\u00d5\u00d3\3\2\2\2\u00d6\u00d7\t\6\2\2\u00d7")
        buf.write("\61\3\2\2\2\u00d8\u00d9\t\7\2\2\u00d9\63\3\2\2\2\u00da")
        buf.write("\u00db\t\b\2\2\u00db\65\3\2\2\2\24:CPU]ms|\u008b\u0095")
        buf.write("\u009a\u00a2\u00ab\u00b4\u00b8\u00c3\u00ca\u00d3")
        return buf.getvalue()
...
class MambaParser ( Parser ):
    ...
    RULE_returnStmt = 6
    RULE_funcCallStmt = 7
    RULE_assigmentStmt = 8
    RULE_funcDefArgList = 9
    RULE_typedArgList = 10
    RULE_typedArg = 11
    RULE_arithmetic_op = 12
    RULE_arthimeticExpr = 13
    RULE_multiArthimeticExpr = 14
    RULE_comparisonExpr = 15
    RULE_bool_comparison_op = 16
    RULE_booleanLiteral = 17
    RULE_numeric = 18
    RULE_simpleExpression = 19
    RULE_funcCall = 20
    RULE_funcCallDataList = 21
    RULE_dataList = 22
    RULE_data = 23
    RULE_returnType = 24
    RULE_varType = 25

    ruleNames =  [ "program", "package", "funcdef", "signature", "statementList", 
                   "statement", "returnStmt", "funcCallStmt", "assigmentStmt", 
                   "funcDefArgList", "typedArgList", "typedArg", "arithmetic_op", 
                   "arthimeticExpr", "multiArthimeticExpr", "comparisonExpr", 
                   "bool_comparison_op", "booleanLiteral", "numeric", "simpleExpression", 
    ...
    def funcCallStmt(self):
        ...
        self.enterRule(localctx, 14, self.RULE_funcCallStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 95
            self.funcCall()
    ...
    def assigmentStmt(self):
        ...
        self.enterRule(localctx, 16, self.RULE_assigmentStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 98
            self.match(MambaParser.NAME)
    ...
    def funcDefArgList(self):
        ...
        self.enterRule(localctx, 18, self.RULE_funcDefArgList)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 111
    ...
    def typedArgList(self):
        ...
        self.enterRule(localctx, 20, self.RULE_typedArgList)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 117
    ...
    def typedArg(self):
        ...
        self.enterRule(localctx, 22, self.RULE_typedArg)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 125
            self.match(MambaParser.NAME)
    ...
    def arithmetic_op(self):
        ...
        self.enterRule(localctx, 24, self.RULE_arithmetic_op)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 129
    ...
    def arthimeticExpr(self):
        ...
        self.enterRule(localctx, 26, self.RULE_arthimeticExpr)
        self._la = 0 # Token type
        try:
            self.state = 152
            self._errHandler.sync(self)
    ...
    def multiArthimeticExpr(self):
        ...
        self.enterRule(localctx, 28, self.RULE_multiArthimeticExpr)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 154
    ...
    class ComparisonExprContext(ParserRuleContext):
        ...
        def bool_comparison_op(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(MambaParser.Bool_comparison_opContext)
            else:
                return self.getTypedRuleContext(MambaParser.Bool_comparison_opContext,i)
    ...
    def bool_comparison_op(self):
        ...
        self.enterRule(localctx, 32, self.RULE_bool_comparison_op)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 184
    ...
    def numeric(self):
        ...
        self.enterRule(localctx, 36, self.RULE_numeric)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 188
    ...
    def funcCallDataList(self):
        ...
        self.enterRule(localctx, 42, self.RULE_funcCallDataList)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 198
    ...
    def dataList(self):
        ...
        self.enterRule(localctx, 44, self.RULE_dataList)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 204
    ...
    def data(self):
        ...
        self.enterRule(localctx, 46, self.RULE_data)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 212
    ...
    def varType(self):
        ...
        self.enterRule(localctx, 50, self.RULE_varType)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 216
